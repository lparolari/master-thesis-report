...
\end{equation}
Outside of this section, we use the notation $\bm{P}$ for referring to
the prediction matrix, and whether the concept similarity is applied
or not is an implementation detail.
